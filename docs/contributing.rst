...
.. _ambitioninc repository: https://github.com/ambitioninc/gagrab/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/ambitioninc/gagrab.git
    $ cd gagrab
    $ virtualenv env
    $ . env/bin/activate
    $ pip install nose
...
.. code-block:: python
    ...
    from gagrab.version import __version__
...
When in the project directory::
    ...
    $ pip uninstall -y gagrab && python setup.py install
    $ cd docs && make html
...
* Bump version in gagrab/version.py
